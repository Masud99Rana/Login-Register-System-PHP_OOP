...
# Login Register System ( Object Oriented Authentication System )
> **Note:** This repository contains the core code of an object oriented authentication system.
...
## About The Project
An object oriented authentication system including the ability to register a user & use the resources. In this project, I have practiced how to develop a real-world, Object Oriented Authentication System in PHP.
...
1. Clone the repo
```sh
git remote add origin https://github.com/Masud99Rana/Login-Register-System-PHP_OOP.git
```
